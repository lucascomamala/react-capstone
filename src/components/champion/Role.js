      ...
      return (
        <li className="specs-item">
          <div className="specs-item-icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className="role-icon">
          ...
          <div className="specs-string">Role</div>
          <div className="specs-value">Fighter</div>
        </li>
      );
    case 'Mage':
      return (
        <li className="specs-item">
          <div className="specs-item-icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className="role-icon">
              <path d="M84.48 77.3h13.41l-3.83-12.93h-9.58a36.73 36.73 0 00-27.54 12.45L50 85l-6.94-8.14a36.73 36.73 0 00-27.54-12.49H5.94L2.11 77.3h13.41a36.73 36.73 0 0127.54 12.45l.71.72h-9.1v7.42h30.9v-7.42h-9.1l.71-.72a35.85 35.85 0 0127.3-12.45" />
              <path d="M56.23 54.31L50 62.21l-6.23-7.9a5.42 5.42 0 01-.24-6.47L50 37.31l6.47 10.53a5.42 5.42 0 01-.24 6.47M42.58 28.93l-7.91 12.69a13.37 13.37 0 00.72 15.09L50 75.14l14.61-18.43a13 13 0 00.72-15.09L50 17l-.48.72a5.58 5.58 0 01-4.31 1.68c-4.07 0-7.18-8.62 4.55-17.24 0 0-28.74 5.5-14.85 30.41z" />
            </svg>
          </div>
          <div className="specs-string">Role</div>
          <div className="specs-value">Mage</div>
        </li>
      );
    case 'Assassin':
      return (
        <li className="specs-item">
          <div className="specs-item-icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className="role-icon">
              <path d="M56.59 73.71l1.67-2.88c5.75-9.34 5.51-16 3.83-20.59a39.78 39.78 0 01-9.1 16 2 2 0 01-1.43.48H48.2a2.17 2.17 0 01-1.67-.72 39.78 39.78 0 01-9.1-16c-1.68 4.55-1.68 11.26 3.83 20.59l1.68 2.88-3.36 5.75 10.06 17.72L59.7 79.22z" />
          ...
          <div className="specs-string">Role</div>
          <div className="specs-value">Assassin</div>
        </li>
      );
    case 'Marksman':
      return (
        <li className="specs-item">
          ...
          <div className="specs-string">Role</div>
          <div className="specs-value">Marksman</div>
        </li>
      );
    case 'Tank':
      return (
        <li className="specs-item">
          <div className="specs-item-icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className="role-icon">
              ...
              <path d="M78.74 32.28L62 21.26v5.27H38v-5.27l-16.26 7.19a2.9 2.9 0 00-1.67 3.11l4.31 19.16a3.22 3.22 0 002.15 2.15l11.26 2.4V50h23.94v5.27l11.5-2.4a2.52 2.52 0 002.15-2.15l4.31-15.57a2.39 2.39 0 00-1-2.87M57.42 20.07H42.58L50 11.68z" />
            </svg>
          </div>
          <div className="specs-string">Role</div>
          <div className="specs-value">Tank</div>
        </li>
      );
    case 'Support':
      return (
        <li className="specs-item">
          <div className="specs-item-icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className="role-icon"><path d="M90.4 2.11c0 27.3-25.4 36.63-25.4 36.63L60.94 61a8.39 8.39 0 00-.48 2.39 6.95 6.95 0 0013.89 0 6.7 6.7 0 00-5.75-6.7c6.71-11.5 16.29-6 16.29-6 1.43-1.44 2.63-2.88 3.83-4.07l-7.19-2.88h9.34a38.5 38.5 0 005.75-11.25L87 28.69h10.3a33 33 0 00-6.9-26.58M35.32 38.74S9.93 29.41 9.93 2.11c0 0-9.82 10.77-7.42 26.1h10.3L3.23 32a41.09 41.09 0 004.07 8.9h11l-8.61 3.59a39.83 39.83 0 005.27 6s9.58-5.51 16.29 6a6.7 6.7 0 00-5.75 6.7 6.95 6.95 0 1013.41-2.39zM45.14 22.7l2.63-6.7h4.79l2.63 6.94-5 13.89zm-1-16l-7 16 10.15 25.38v23.71l-5 16 5 10H53l5-10-5-16V48.08L63.1 22.7l-7-16z" /></svg>
          </div>
          <div className="specs-string">Role</div>
          <div className="specs-value">Support</div>
        </li>
      );
    default:
      return null;
