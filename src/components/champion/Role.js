    ...
    case 'Support':
      return (
        <li className="specs-item">
          ...
          <div className="gJhFPq role-string">Role</div>
          <div className="kPaHxk role">Support</div>
        </li>);
  }
}
